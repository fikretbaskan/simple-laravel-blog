<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          <a class="nav-link @if(Request::segment(2)=="articles") in @else collapsed @endif" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <div id="collapseTwo" class="collapse @if(Request::segment(2)=="articles") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item @if(Request::segment(2)=="articles" and Request::segment(3)=="create") active @endif" href="{{route('admin.articles.create')}}">Makale Ekle</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link @if (Request::segment(2)=="categories") text-white @endif" href="{{route('admin.category.index')}}">
            <i class="fas fa-fw fa-list  @if (Request::segment(2)=="categories") text-white @endif"></i>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePage" class="collapse @if(Request::segment(2)=="pages") show @endif" aria-labelledby="headingPage" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item @if(Request::segment(2)=="pages" and Request::segment(3)=="create") active @endif" href="{{route('admin.page.create')}}">Sayfa Ekle</a>
            </div>
          </div>
        </li>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <a href="{{route('homepage')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-link fa-sm text-white-50"></i> Siteyi Görüntüle</a>
            </div>
